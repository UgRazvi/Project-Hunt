...
if (isset($_POST['submit-btn'])) {
    ...
    $sql = "INSERT INTO `service`(`title`,`description`, `file_name`, `status`) VALUES ('$Title','$Description', '$dst','1')";
        ...
        <div id="content">
            ...
            <div class="addActivitiesContainer">
                ...
                <div class="tab-content">
                    ...
                    <form action="new-service.php" method="POST" enctype="multipart/form-data">
                        <h2 class="form-div my-3 " style="text-align: center">Add New Service</h2 style="text-align: center ">
                        ...
                        <div className='thirdRow row'>
                            ...
                            <input className=" form-control" type="text" id="exampleInputTitile" name="title" placeholder="Service Title"></input>
                        </div>
                        <div className='thirdRow row'>
                            <label class="pl-2 form-label" htmlFor='exampleInputTextarea'></label>
                            <textarea className="py-2 form-control" type="textarea" id='exampleInputTextarea' rows="8" name="description" minLength={1} rows="7" placeholder="Service Description" cols="80"></textarea>
                        </div>
                        


                        <!-- Submit button -->
                        <button type="submit" class="btn btn-primary btn-block mb-3" name="submit-btn">Add Service</button>
                    </form>
                </div>
                <!-- Pills content -->
            </div>
